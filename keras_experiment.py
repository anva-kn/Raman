...
#-------------------------------    15000 PPB    ----------------------------------------------
length = mix_15000_area_1.shape[1] - 1
f_sup = np.array(mix_15000_area_1.iloc[:, 0], dtype=np.float64)
data_15000_area1 = np.zeros((length, f_sup.shape[0]))
data_15000_area2 = np.zeros((length, f_sup.shape[0]))
data_15000_area3 = np.zeros((length, f_sup.shape[0]))
data_15000_area4 = np.zeros((length, f_sup.shape[0]))

data_1500_area1 = np.zeros((length, f_sup.shape[0]))
data_1500_area2 = np.zeros((length, f_sup.shape[0]))
data_1500_area3 = np.zeros((length, f_sup.shape[0]))
data_1500_area4 = np.zeros((length, f_sup.shape[0]))
