...
recap_spectrum(f_sup,data_MG_mean,num_peaks,comp_rangeM, comp_beta_gaussM, comp_beta_lorM, comp_beta_gen_lorM, comp_beta_cosM, comp_MSEM, comp_biasM)
...
# check special  correlation with 
